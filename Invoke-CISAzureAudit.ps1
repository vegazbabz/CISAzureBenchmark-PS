...
.DESCRIPTION
    Compatibility shim: imports the CISAzureBenchmark module and forwards all
...
Import-Module (Join-Path $PSScriptRoot "CISAzureBenchmark.psd1") -Force
...
$summary = CISAzureBenchmark\Invoke-CISAzureAudit @forward | Select-Object -Last 1
